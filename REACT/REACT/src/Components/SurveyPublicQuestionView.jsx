...
export default function SurveyPublicQuestionView({
    question, 
    index,
    answerChanged,
}) {
             ...
             {question.type === "radio" && (
              ...
              {question.type === "text" && (
               <div>
                ...
                type="text"
                onChange={(ev) => answerChanged(ev.target.value)}
                className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-[black] rounded-md p-2"
                />
               </div>
             )}
